              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <img src="{{ asset('/storage/job/'. $jobs->foto)}}" alt="" style="width: 90px;">
                    
                    <div class="d-flex flex-column ">
                      <h6 class="mb-1 text-dark text-sm" style="margin-left: 10px;">{{$jobs->judul}}</h6>
                      <span class="text-xs" style="margin-left: 10px;">{{$jobs->nama_perusahaan}}, <span class="font-weight-bold">{{$jobs->lokasi}}</span></span>
                    </div>
                  </div>
                  <div class="d-flex">
                  <a href="{{route('job.show', $jobs->id)}}" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
