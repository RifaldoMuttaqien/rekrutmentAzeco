...
<body class="g-sidenav-show   bg-gray-100">
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Tambahkan Lowongan Kerja</p>
            ...
            @csrf
              ...
              <p class="text-uppercase text-sm">LOKER Information</p>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Foto</label>
                    <input class="form-control" type="file" value="foto" name="foto" id="foto">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Judul</label>
                    <input class="form-control" type="text" value="{{ old('judul') }}" name="judul" id="judul">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Syarat</label>
                    <input class="form-control" type="text" value="{{ old('syarat') }}" name="syarat" id="syarat">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Nama Perusahaan</label>
                    <input class="form-control" type="text" value="" name="nama_perusahaan" id="nama_perusahaan">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Lokasi</label>
                    <input class="form-control" type="text" value="{{ old('lokasi') }}" name="lokasi" id="lokasi">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Gaji</label>
                    <input class="form-control" type="number" value="{{ old('gaji') }}" name="gaji" id="gaji">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="status" class="form-control" id="status">
                        ...
                        <option value="2">Tidak Tayang</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Dipositng oleh</label>
                    @foreach ($user as $users)
                    <input class="form-control" type="text" value="{{$users->id}}" name="diposting_oleh" id="diposting_oleh">
                    @endforeach
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          ...
          <p>See our Lowongan Kerja options.</p>
        </div>
  ...
  <script src="{{url('argon/assets/js/plugins/chartjs.min.js')}}"></script>
  <script>
