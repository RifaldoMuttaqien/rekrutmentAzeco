                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ijasah</th>
                  ...
                  <tbody>
                    ...
                    <td>{{$applicantss->name}}</td>
                    <td>{{$applicantss->email}}</td>
                    <td>{{$applicantss->role}}</td>
                    <td><a href="{{ asset('/storage/cv/'. $applicantss->cv) }}" target="_blank">
                        <img src="{{ asset('/storage/cv/'. $applicantss->cv) }}" alt="CV" style="width: 100px;">
                      </a></td>
                      <td><a href="{{ asset('/storage/ktp/'. $applicantss->ktp) }}" target="_blank">
                        <img src="{{ asset('/storage/ktp/'. $applicantss->ktp) }}" alt="ktp" style="width: 100px;">
                      </a></td>
                      <td><a href="{{ asset('/storage/ijasah/'. $applicantss->ijasah) }}" target="_blank">
                        <img src="{{ asset('/storage/ijasah/'. $applicantss->ijasah) }}" alt="ijasah" style="width: 100px;">
                      </a></td>
                    
               
                    <td>{{$applicantss->alamat}}</td>
                    <td>{{$applicantss->telepon}}</td>
