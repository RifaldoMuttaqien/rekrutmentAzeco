            ...
            <div class="col-md-4">
              <div class="card border-0 shadow-sm rounded">
                <div class="card-body text-center">
                  <img src="{{ asset('/storage/job/'. $job->foto)}}" alt="" style="width: 15em;">
                </div>
              </div>
            </div>
            <div class="col-md-8">
              <div class="card border-0 shadow-sm rounded">
                <div class="card-body">
                  ...
                  <div class="card-desc mt-3">
                    <p style="color: red;">{{$job->deskripsi}}</p>
                    <p style="color: red;">{{$job->syarat}}</p>
                  </div>
                  <hr style="background-color: black;" />
                  <div class="row ">
                    <div class="col">{{$job->status}}</div>
                    <div class="col">{{$job->diposting_oleh}}</div>
                  </div>
                  <form action="{{route('job.lamarJob', $job->id)}}" method="POST">
                    @csrf
                  <div class=" d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <button class="btn btn-success btn-sm" type="submit"><i class="bi bi-arrow-bar-right"></i>Lamar</button>
                  </div>
                  </form>
