    ...
    <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a href="{{route('job.create')}}" class="btn btn-md btn-success mb-3">Tambah Lowongan Kerja</a> 
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <td><img src="{{ asset('/storage/job/'. $jobs->foto)}}" alt="" style="width: 100px;"></td>
                    <td>{{$jobs->status}}</td>
                    <td>{{$jobs->lokasi}}</td>
                      <td class="align-middle">
                        ...
                        <a href="{{route('job.show', $jobs->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Lihat
                        </a>
                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Hapus
